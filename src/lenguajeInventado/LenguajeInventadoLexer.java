...
public class LenguajeInventadoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "FLOAT", "NUMERO", "VARIABLE", "FINLINEA", "STRING", 
			"COMENTARIOABRIR", "COMENTARIOCERRAR", "COMENTARIOLINEA", "COMENTARIOALMOHADILLA", 
			"SEPARADOR", "OPERACION", "INTRO", "NEWLINE", "OPERADORESCOND", "FINCONDICION", 
			"IF", "ELSE", "FINCOND", "VALORES", "ESPACIO", "TEXTO"
		};
	}
