...
public class LenguajeInventadoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ESPACIO", "NEWLINE", "PARENTESIS", "IGUAL", "FLOAT", "NUMERO", "VARIABLE", 
			"FINLINEA", "STRING", "COMENTARIOABRIR", "COMENTARIOCERRAR", "COMENTARIOLINEA", 
			"COMENTARIOALMOHADILLA", "SEPARADOR", "INTRO", "INDEC", "OPERADORESCOND", 
			"FINCONDICION", "IF", "ELSE", "FINCOND", "VALORES", "ASIGNAR", "MOSTRAR", 
			"TEXTO", "OPERACION"
		};
	}
