...
receta:ACCIONES  DETERMINANTES? (CANTIDAD UNIDADES PREPOSICIONES)? INGREDIENTES PREPOSICIONES DETERMINANTES UTENSILIOS (PREPOSICIONES CUBIERTOS)? (PREPOSICIONES TIEMPO)?;
