...
public class recetasParser extends Parser {
	...
	public static final int
		...
		CANTIDAD=7, DETERMINANTES=8, PREPOSICIONES=9, TIEMPO=10, COMENTARIOABRIR=11, 
		COMENTARIOCERRAR=12, COMENTARIOLINEA=13, COMENTARIOALMOHADILLA=14, SEPARADOR=15, 
		ESPACIO=16, NEWLINE=17;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ACCIONES", "CANTIDAD", "DETERMINANTES", "PREPOSICIONES", "TIEMPO", "COMENTARIOABRIR", 
