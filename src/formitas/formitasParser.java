...
public class formitasParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, COLORES=3, ESPACIO=4, NEWLINE=5, FIGURA=6, APERTURA=7, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, "COLORES", "ESPACIO", "NEWLINE", "FIGURA", "APERTURA", 
	...
	public static class CampoContext extends ParserRuleContext {
		...
		public TerminalNode COLORES() { return getToken(formitasParser.COLORES, 0); }
