// Generated from C:/Users/carlo/OneDrive - Universidad de Alcala/3anyo/1cuatri/Compiladores/LABORATORIO/Pl2Compiladores/PL2Compiladores/src/formitas\formitas.g4 by ANTLR 4.10.1
package formitas;
...
public class formitasParser extends Parser {
	...
	public static final int
		T__0=1, APERTURA=2, CERRADURA=3, CUADRADO=4, CIRCULO=5, TRIANGULO=6, IMGDIM=7, 
		SHPDIM=8, FINLINEA=9, SEPARADOR=10, NUMERO=11;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'|'", "'>>>'", "'<<<'", "'cuadrado'", "'circulo'", "'triangulo'", 
			null, null, null, "','"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, "APERTURA", "CERRADURA", "CUADRADO", "CIRCULO", "TRIANGULO", 
			"IMGDIM", "SHPDIM", "FINLINEA", "SEPARADOR", "NUMERO"
		};
	}
	...
	public static class CampoContext extends ParserRuleContext {
		public TerminalNode CUADRADO() { return getToken(formitasParser.CUADRADO, 0); }
		public TerminalNode CIRCULO() { return getToken(formitasParser.CIRCULO, 0); }
		public TerminalNode TRIANGULO() { return getToken(formitasParser.TRIANGULO, 0); }
	...
	public final CampoContext campo() throws RecognitionException {
		...
		try {
			...
			setState(33);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << CUADRADO) | (1L << CIRCULO) | (1L << TRIANGULO))) != 0)) ) {
